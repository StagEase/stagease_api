package stag.ease.stagease.service.impl;
...
import stag.ease.stagease.util.KeycloakProvider;
...
public class KeycloakServiceImpl implements IKeycloakService {
    ...
    public String createUser(@NonNull UserDTO userDTO) {
        ...
        if(status == 201){
            ...
            return ("Usuario creado com sucesso!");
        } else if (status == 409) {
            log.error("Ja tem um usuario com ese nome logado");
            return ("Ja tem um usuario com ese nome logado");
        } else {
            log.error("Erro ao criar um usuario");
            return ("Erro ao criar um usuario");
        }
    }
